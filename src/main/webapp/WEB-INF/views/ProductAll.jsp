...
<body>
    ...
    <div id="content">
        ...
        <div id="filter">
            <form method="get" action="${pageContext.request.contextPath}/ProductAll.do">
        ...
        <div id="product" class="clear">
            <ul id="grid">
				...
				<li>
		            <div class="img">
		                <a href="Detail.do/${row.product_no}">
        ...
        <div class="hs_paging">
	        ...
	        <c:choose>
				...
				<c:when test="${pageData.prevPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/ProductAll.do" var="prevPageUrl">
			...
			<c:forEach var="i" begin="${pageData.startPage}"
				...
				<%-- 이동할 URL 생성 --%>
				<c:url value="/ProductAll.do" var="pageUrl">
			...
			<c:choose>
				...
				<c:when test="${pageData.nextPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/ProductAll.do" var="nextPageUrl">
