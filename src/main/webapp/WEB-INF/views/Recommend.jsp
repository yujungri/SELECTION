...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <form method="get" action="${pageContext.request.contextPath}/Recommend.do" id="form2">
            <div class="searchbox">
                <input placeholder="search..." type="search" name="search" id="search" />
                <input type="image" src="assets/image/search.png" onclick="$('#form2').submit();" id="search_image"/>
            </div>
            </form>
            <li class="title"><h1>추천상품</h1></li>
    ...
    <div id="content">
        ...
        <div id="filter">
            <form method="get" action="${pageContext.request.contextPath}/Recommend.do">
    	...
    	<div id="product" class="clear">
            <ul id="grid">
				...
				<li>
		            <div class="img">
		                <a href="RecommendDetail.do/${row.product_no}">
        ...
        <div class="hs_paging">
	        ...
	        <c:choose>
				...
				<c:when test="${pageData.prevPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Recommend.do" var="prevPageUrl">
			...
			<c:forEach var="i" begin="${pageData.startPage}"
				...
				<%-- 이동할 URL 생성 --%>
				<c:url value="/Recommend.do" var="pageUrl">
			...
			<c:choose>
				...
				<c:when test="${pageData.nextPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Recommend.do" var="nextPageUrl">
