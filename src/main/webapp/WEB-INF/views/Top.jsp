...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <form method="get" action="${pageContext.request.contextPath}/Top.do" id="form2">
            <div class="searchbox">
                <input placeholder="search..." type="search" name="search" id="search" />
                <input type="image" src="assets/image/search.png" onclick="$('#form2').submit();" id="search_image"/>
            </div>
            </form>
            <li class="title"><h1>Top</h1></li>
    ...
    <div id="content">
        ...
        <div id="filter">
            <form method="get" action="${pageContext.request.contextPath}/Top.do">
    	...
    	<div id="product" class="clear">
            <ul id="grid">
				...
				<li>
		            <div class="img">
		                <a href="TopDetail.do/${row.product_no}">
        ...
        <div class="hs_paging">
	        ...
	        <c:choose>
				...
				<c:when test="${pageData.prevPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Top.do" var="prevPageUrl">
			...
			<c:forEach var="i" begin="${pageData.startPage}"
				...
				<%-- 이동할 URL 생성 --%>
				<c:url value="/Top.do" var="pageUrl">
			...
			<c:choose>
				...
				<c:when test="${pageData.nextPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Top.do" var="nextPageUrl">
