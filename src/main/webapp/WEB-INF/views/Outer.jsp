...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <form method="get" action="${pageContext.request.contextPath}/Outer.do" id="form2">
            <div class="searchbox">
    ...
    <div id="content">
        ...
        <div id="filter">
            <form method="get" action="${pageContext.request.contextPath}/Outer.do">
    	...
    	<div id="product" class="clear">
            <ul id="grid">
				...
				<li>
		            <div class="img">
		                <a href="OuterDetail.do/${row.product_no}">
        ...
        <div class="hs_paging">
	        ...
	        <c:choose>
				...
				<c:when test="${pageData.prevPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Outer.do" var="prevPageUrl">
			...
			<c:forEach var="i" begin="${pageData.startPage}"
				...
				<%-- 이동할 URL 생성 --%>
				<c:url value="/Outer.do" var="pageUrl">
			...
			<c:choose>
				...
				<c:when test="${pageData.nextPage > 0}">
					<%-- 이동할 URL 생성 --%>
					<c:url value="/Outer.do" var="nextPageUrl">
